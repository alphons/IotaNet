...
namespace IotaNet.Iri
{
	...
	public class Iota
	{
		private static  Logger log = LoggerFactory.getLogger<Iota>();

    public static  String MAINNET_COORDINATOR_ADDRESS = "KPWCHICGJZXKE9GSUDXZYUAPLHAKAHYHDXNPHENTERYMMBQOPSQIDENXKLKCEYCPVTZQLEEJVYJZV9BWU";
    public static  Model.Hash MAINNET_COORDINATOR = new Model.Hash(MAINNET_COORDINATOR_ADDRESS);
		public static  String TESTNET_COORDINATOR_ADDRESS = "XNZBYAST9BETSDNOVQKKTBECYIPMF9IPOZRWUPFQGVH9HJW9NDSQVIPVBWU9YKECRYGDSJXYMZGHZDXCA";
    public static  Model.Hash TESTNET_COORDINATOR = new Model.Hash(TESTNET_COORDINATOR_ADDRESS);
    ...
    public  TransactionRequester transactionRequester;
    public  Node node;
    public  UDPReceiver udpReceiver;
    public  Replicator replicator;
    public  Configuration configuration;
    public  Model.Hash coordinator;
    ...
    public  int maxPeers;
		...
		public Iota(Configuration configuration)
		{
			...
			if (testnet)
			{
				...
				{
					coordinator = new Model.Hash(coordinatorTrytes);
				}
				else
				{
...
private void initializeTangle()
{
	...
	if (testnet)
	{
		if (string.IsNullOrWhiteSpace( dbPath ) || dbPath == "mainnetdb")
		{
	...
	{
		if (string.IsNullOrWhiteSpace( dbPath ) || dbPath == "testnetdb")
		{
